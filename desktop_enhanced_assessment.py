#!/usr/bin/env python3
"""
Desktop Enhanced Assessment - Full-Width Professional UI
Enhanced visual design optimized for desktop experience
"""
...
app = FastAPI(title="Desktop Enhanced Assessment")
...
def show_question(q_num: int):
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Question {q_num} - Cruise Assessment</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <style>
            * {{
                margin: 0;
            ...
            .passage-container {{
                background: linear-gradient(135deg, #f4e6ff 0%, #fff0ff 100%);
                border-radius: 20px;
                padding: 35px;
            ...
            .submit-btn:hover:not(:disabled) {{
                transform: translateY(-3px) scale(1.05);
                box-shadow: 0 25px 50px rgba(39, 174, 96, 0.4);
            }}
...
def show_results():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Assessment Results - Cruise English Platform</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <style>
            * {{
                margin: 0;
            ...
            .overall-score {{
                background: {"linear-gradient(135deg, #27ae60, #2ecc71)" if passed else "linear-gradient(135deg, #e74c3c, #f39c12)"};
                color: white;
                padding: 50px;
                border-radius: 32px;
                margin: 40px 0;
            ...
            .feature-item {{
                ...
                color: #2c3e50;
                padding: 15px 20px;
                background: linear-gradient(135f, #f8f9fa 0%, #ffffff 100%);
                border-radius: 16px;
                border: 2px solid #e9ecef;
                transition: all 0.3s ease;
            }}
...
def generate_module_results(module_scores):
    html = ""
    module_info = {
        "listening": {"name": "🎧 Listening Comprehension", "color": "#3498db"},
        "time_numbers": {"name": "🔢 Time & Numbers", "color": "#e67e22"},
        "grammar": {"name": "📝 Grammar", "color": "#9b59b6"},
        "vocabulary": {"name": "📚 Vocabulary", "color": "#1abc9c"},
        "reading": {"name": "📖 Reading Comprehension", "color": "#34495e"},
        "speaking": {"name": "🎤 Speaking", "color": "#e74c3c"}
    }

    for module, data in module_scores.items():
        percentage = (data["score"] / data["total"]) * 100 if data["total"] > 0 else 0
        info = module_info.get(module, {"name": module.title(), "color": "#95a5a6"})
...
if __name__ == "__main__":
    print("Starting Desktop Enhanced Assessment...")
    print("Full-width professional interface optimized for desktop")
    print("URL: http://127.0.0.1:8010")
